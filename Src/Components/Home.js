...
import {
  ...
  setMenu,
  setPagecount,
} from "../store/action/profile/profile";
      ...
      <Modal transparent={true} visible={showModal}>
        ...
        >
          <SafeAreaView>
              ...
              >
                <TouchableOpacity>
                  <Image
                    resizeMode="stretch"
                    source={{
                      uri: statue.User_Image_Path
                        ? statue.User_Image_Path
            ...
            {statue.US_Doc_Type === "Document" && (
              <TouchableOpacity
                onPress={() => WebViewPage(statue.US_ImagePath)}
                style={{
                  width: "100%",
                  height: 200,
    ...
    return (
      ...
      >
        ...
        {item.US_Doc_Type === "Document" && (
          ...
          >
            <AntDesign name={"filetext1"} size={30} color="#DBBE80" />
          </TouchableOpacity>
        )}
        {item.US_Doc_Type === "Audio" && (
          ...
          >
            <AntDesign name={"sound"} size={30} color="#DBBE80" />
          </TouchableOpacity>
        )}
      ...
      <View style={{ marginTop: 10 }}>
        <View style={styles.bar}>
          ...
          {item.UP_PKeyID === id && (
            ...
            >
              <Text style={{ color: "#DBBE80" }}>Share</Text>
            </TouchableOpacity>
          )}
          <View style={styles.dot}>
            <TouchableOpacity onPress={() => ShowShareButton(item)}>
              <Entypo name={"dots-three-vertical"} size={20} color="#BDBEC1" />
            </TouchableOpacity>
          </View>
        </View>
        <View style={styles.image}>
          ...
          {item.UP_Doc_Type === "Document" && (
            <TouchableOpacity
              onPress={() => WebViewPage(item.UP_ImagePath)}
              style={{
                ...styles.image1,
                justifyContent: "center",
                alignItems: "center",
            ...
            >
              <AntDesign name={"filetext1"} size={200} color="#DBBE80" />
              <Text
                style={{
                  alignSelf: "center",
                  marginVertical: 10,
          ...
          {item.UP_Doc_Type === "Audio" && (
            <TouchableOpacity
              onPress={() => PlayTrack(item.UP_ImagePath)}
              style={{
                ...styles.image1,
                justifyContent: "center",
                alignItems: "center",
          ...
          <View style={styles.icon10}>
            ...
            >
              <View style={styles.icontext}>
                <TouchableOpacity
                  onPress={() => CreateUpdateUserFavorite(item.UP_PKeyID)}
                >
                  <AntDesign
              ...
              <View style={styles.icontext}>
                <TouchableOpacity>
                  <Feather name={"message-circle"} size={24} color="#807C7D" />
                </TouchableOpacity>
                <View>
        ...
        >
          ...
          >
            ...
            >
              ...
              >
                <Feather name={"plus"} size={24} color="#DBBE80" />
              </View>
              <Text style={{ marginTop: 10 }}>Add story</Text>
            </TouchableOpacity>
            <View>
              <FlatList
