      ...
      >
        {item.US_Doc_Type === "Image" && (
          <TouchableOpacity style={styles.storyContainer}>
            <Image
              resizeMode="stretch"
              style={{ height: 60, width: 70, borderRadius: 500 }}
              source={{
                uri: item.US_ImagePath
                  ? item.US_ImagePath
        ...
        {item.US_Doc_Type === "Document" && (
          <TouchableOpacity style={styles.storyContainer}>
            <AntDesign name={"filetext1"} size={40} color="#DBBE80" />
          </TouchableOpacity>
        )}
        {item.US_Doc_Type === "Audio" && (
          <TouchableOpacity style={styles.storyContainer}>
            <AntDesign name={"sound"} size={40} color="#DBBE80" />
          </TouchableOpacity>
        )}
      ...
      <View style={{ marginHorizontal: 10, flex: 1, marginTop: 5 }}>
        <View>
          ...
          >
            ...
            <View style={{ width: "75%" }}>
              <Text style={{ fontSize: 15, color: "#9B9C9F", lineHeight: 22 }}>
                Lorem Ipsum has been the to going industry's standard dummy text
        ...
        <View style={styles.buttonConatainer}>
          <TouchableOpacity
            ...
            style={{
              ...styles.box,
              backgroundColor: issubscriber ? "#DBBE80" : "#EAE2D1",
              borderWidth: 1,
              borderColor: "#EAE2D1",
            }}
          >
            <Text
              style={{
                ...styles.subscribe,
                color: issubscriber ? "#ffffff" : "#DBBE80",
              }}
            >
              {"Subscribe"}
            </Text>
          ...
          <TouchableOpacity
            ...
            style={{
              ...styles.box,
              backgroundColor: ismsg ? "#DBBE80" : "#EAE2D1",
              borderWidth: 1,
              borderColor: "#EAE2D1",
            }}
          >
          ...
          <TouchableOpacity
            ...
            style={{
              ...styles.box,
              backgroundColor: issponsor ? "#DBBE80" : "#EAE2D1",
              borderWidth: 1,
              borderColor: "#EAE2D1",
            }}
          >
          ...
          <TouchableOpacity
            ...
            style={{
              ...styles.box,
              backgroundColor: istip ? "#DBBE80" : "#EAE2D1",
              borderWidth: 1,
              borderColor: "#EAE2D1",
            }}
          >
        ...
        <View style={{ flexDirection: "row" }}>
          <TouchableOpacity
            style={{
              ...styles.button,
              borderBottomWidth: isdoc ? 2 : 1,
              borderBottomColor: isdoc ? "#DBBE80" : "lightgray",
            }}
          ...
          <TouchableOpacity
            style={{
              ...styles.button,
              borderBottomWidth: isimg ? 2 : 1,
              borderBottomColor: isimg ? "#DBBE80" : "lightgray",
            }}
            onPress={() => onOpenImage()}
          >
            <View style={styles.view}>
          ...
          <TouchableOpacity
            style={{
              ...styles.button,
              borderBottomWidth: isvdo ? 2 : 1,
              borderBottomColor: isvdo ? "#DBBE80" : "lightgray",
            }}
            onPress={() => openVideo()}
          >
            <View style={styles.view}>
          ...
          <TouchableOpacity
            style={{
              ...styles.button,
              borderBottomWidth: ismic ? 2 : 1,
              borderBottomColor: ismic ? "#DBBE80" : "lightgray",
            }}
            onPress={() => OpenMusic()}
          >
            <View style={styles.view}>
        ...
        <ScrollView>
          ...
          >
            {isimg &&
              imagedata.map((item) => {
                return (
                  <View style={{ width: "33%", height: 120, padding: 5 }}>
                    <FastImage
                      style={{
                        height: "100%",
                        width: "100%",
